...
class Korean(object):
    ...
    class Syllable(object):
        ...
        def __init__(self, **kwargs):
            ...
            self.letter = letter
            self.phoneme_onset = phoneme_onset if phoneme_onset is not '' else None
            self.phoneme_nucleus = phoneme_nucleus if phoneme_nucleus is not '' else None
            self.phoneme_coda = phoneme_coda if phoneme_coda is not '' else None
        ...
        def combine(self):
            phoneme_onset = self.phoneme_onset if self.phoneme_onset is not ' ' else 'ㅇ'
            phoneme_nucleus = self.phoneme_nucleus if self.phoneme_nucleus is not ' ' else None
